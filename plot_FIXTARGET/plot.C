...
void plot(){
      ...
      c1->SaveAs("plot/resolution_GP.png");
      c1->SaveAs("plot/resolution_GP.pdf");
   	//----------------------------------------------------------------------------------------------------------------------------------------------
      ...
      c4->SaveAs("plot/pion_minus_v1.png");
      ...
      c5->SaveAs("plot/pion_plus_v1.png");
      ...
      c6->SaveAs("plot/lambda_v1.png");
      c6->SaveAs("plot/lambda_v1.pdf");
      ...
      c8->SaveAs("plot/lambda_pT.png");

      //--------------------------------------------------------------------- lambda transverse polarization----------------------------------------------------------------    
      ...
      c9->Divide(3,1);
      c9->cd(1);
      h2D_sin_phi_star_EP_un_weight_y_pos->Scale( 800/(alpha*TMath::Pi()*Res_20_50 ) );
      fitFunc->SetLineColor(kRed);
      fitFunc->SetLineWidth(4);
      h2D_sin_phi_star_EP_un_weight_y_pos->Fit(fitFunc,"0");
      TF1 *fit_unweight= (TF1*)fitFunc->Clone("unweighted");
      h2D_sin_phi_star_EP_un_weight_y_pos->Draw();
      ...
      c9->cd(2);
      h2D_sin_phi_star_EP_weight_y_pos->Scale( 800/(alpha*TMath::Pi()*Res_20_50 ) );
      fitFunc->SetLineColor(kBlue);
      fitFunc->SetLineWidth(4);
      h2D_sin_phi_star_EP_weight_y_pos->Fit(fitFunc,"0");
      TF1 *fit_weight= (TF1*)fitFunc->Clone("weighted");
      h2D_sin_phi_star_EP_weight_y_pos->Draw();
      text->DrawLatexNDC(0.15, 0.4, "Event Plane");
      ...
      c9->cd(3);
      h2D_sin_phi_star_EP_sample_y_pos->Scale( 800/(alpha*TMath::Pi()*Res_20_50 ) );
      h2D_sin_phi_star_EP_sample_y_pos->Fit(fitFunc);
      h2D_sin_phi_star_EP_sample_y_pos->Draw();
      text->DrawLatexNDC(0.15, 0.4, "Event Plane");
      ...
      c9->SaveAs("plot/GP_VS_u_EP.png");



      //--------------------------------------------------------------------- lambda global polarization for paper plot----------------------------------------------------------------    
      ...
      h2D_sin_phi_star_EP_un_weight_y_pos->GetXaxis()->SetTitle("#phi_{#Lambda}- #phi_{p}*");
      h2D_sin_phi_star_EP_un_weight_y_pos->GetXaxis()->SetTitleSize(0.045);
      h2D_sin_phi_star_EP_un_weight_y_pos->GetXaxis()->CenterTitle();
      h2D_sin_phi_star_EP_un_weight_y_pos->GetYaxis()->SetTitle("#frac{8}{#pi #alpha_{#Lambda}} #frac{1}{R^{(1)}_{EP}} #LT sin( #Psi_{EP}^{(1)} - #phi_{p}* ) #GT (%)");
      h2D_sin_phi_star_EP_un_weight_y_pos->GetYaxis()->SetTitleSize(0.045);
      h2D_sin_phi_star_EP_un_weight_y_pos->GetYaxis()->SetTitleOffset(0.91);
      h2D_sin_phi_star_EP_un_weight_y_pos->GetYaxis()->SetNdivisions(505);
      h2D_sin_phi_star_EP_un_weight_y_pos->GetYaxis()->CenterTitle();

      h2D_sin_phi_star_EP_un_weight_y_pos->SetStats(0);
      h2D_sin_phi_star_EP_un_weight_y_pos->SetMarkerStyle(4);
      h2D_sin_phi_star_EP_un_weight_y_pos->SetMarkerSize(1);
      h2D_sin_phi_star_EP_un_weight_y_pos->SetMarkerColor(kRed);
      h2D_sin_phi_star_EP_un_weight_y_pos->SetLineColor(kRed);
      
      h2D_sin_phi_star_EP_un_weight_y_pos->SetTitle("");
      h2D_sin_phi_star_EP_un_weight_y_pos->Draw("E");



      h2D_sin_phi_star_EP_weight_y_pos->GetXaxis()->SetTitle("#phi_{#Lambda}-#phi_{p}*");
      h2D_sin_phi_star_EP_weight_y_pos->GetXaxis()->CenterTitle();
      h2D_sin_phi_star_EP_weight_y_pos->GetYaxis()->SetTitleSize(0.045);
      h2D_sin_phi_star_EP_weight_y_pos->GetYaxis()->SetTitle("#frac{8}{#pi #alpha_{#Lambda}} #frac{1}{R^{(1)}_{EP}} #LT sin( #Psi_{EP}^{(1)} - #phi_{p}* ) #GT (%)");
      h2D_sin_phi_star_EP_weight_y_pos->GetYaxis()->CenterTitle();
      h2D_sin_phi_star_EP_weight_y_pos->GetYaxis()->SetTitleSize(0.045);
      h2D_sin_phi_star_EP_weight_y_pos->SetStats(0);

      h2D_sin_phi_star_EP_weight_y_pos->SetMarkerStyle(21);
      h2D_sin_phi_star_EP_weight_y_pos->SetMarkerSize(1);
      h2D_sin_phi_star_EP_weight_y_pos->SetMarkerColor(kBlue);
      h2D_sin_phi_star_EP_weight_y_pos->SetLineColor(kBlue);
      
      h2D_sin_phi_star_EP_weight_y_pos->SetTitle("");
      h2D_sin_phi_star_EP_weight_y_pos->Draw("E same");
      ...
      leg9_1->AddEntry(h2D_sin_phi_star_EP_un_weight_y_pos, Form("Unpolarized"));//, #bar{P}^{(GP)}_{#Lambda} = %.2f %% #pm %.2f %%",fit_unweight->GetParameter(0),fit_unweight->GetParError(0) ), "p");
      leg9_1->AddEntry(h2D_sin_phi_star_EP_weight_y_pos, Form("Polarized"));//, #bar{P}^{(GP)}_{#Lambda} = %.2f %% #pm %.2f %%",fit_weight->GetParameter(0),fit_weight->GetParError(0) ), "p");
      leg9_1->Draw();
      ...
      TAxis *xaxis = h2D_sin_phi_star_EP_un_weight_y_pos->GetXaxis();

      xaxis->SetNdivisions(4, false); // 4个主刻度
      ...
      c9_1->SaveAs("plot/sin_phi_star_EP_y_pos.pdf");
      ...
      //--------------------------------------------------------------------- lambda Global polarization with STAR method for positive rapidity (pos) ----------------------------------------------------------------    

      TCanvas *c10 = new TCanvas("c10","c10",1500,500);
      c10->Divide(3,1);
      c10->cd(1);
      h2D_sin_phi_star_RP_un_weight_y_pos->Scale( 800/(alpha*TMath::Pi()) );
      h2D_sin_phi_star_RP_un_weight_y_pos->Fit(fitFunc);
      h2D_sin_phi_star_RP_un_weight_y_pos->Draw();
      ...
      c10->cd(2);
      h2D_sin_phi_star_RP_weight_y_pos->Scale( 800/(alpha*TMath::Pi()) );
      h2D_sin_phi_star_RP_weight_y_pos->Fit(fitFunc);
      h2D_sin_phi_star_RP_weight_y_pos->Draw();
      //fitFunc->Draw("same");
      text->DrawLatexNDC(0.15, 0.4, "Reaction Plane");
      text->DrawLatexNDC(0.15, 0.3, "weight");
      text->DrawLatexNDC(0.15, 0.2, Form("%.3f + %.3f sin(#phi_{p}*-#phi_{#Lambda})",fitFunc->GetParameter(0),fitFunc->GetParameter(1) ) ) ;
      ...
      c10->cd(3);
      h2D_sin_phi_star_RP_sample_y_pos->Scale( 800/(alpha*TMath::Pi()) );
      h2D_sin_phi_star_RP_sample_y_pos->Fit(fitFunc);
      h2D_sin_phi_star_RP_sample_y_pos->Draw();
      //itFunc->Draw("same");
      text->DrawLatexNDC(0.15, 0.4, "Reaction Plane");
      text->DrawLatexNDC(0.15, 0.3, "Sample");
      text->DrawLatexNDC(0.15, 0.2, Form("%.3f + %.3f sin(#phi_{p}*-#phi_{#Lambda})",fitFunc->GetParameter(0),fitFunc->GetParameter(1) ) ) ;
      ...
      c10->SaveAs("plot/GP_VS_u_RP_pos.png");
      ...
      c11_1->SaveAs("plot/dN_dcos_theta_star_unweight.png");
      c11_1->SaveAs("plot/dN_dcos_theta_star_unweight.pdf");
      ...
      c11_2->SaveAs("plot/dN_dcos_theta_star_weight.png");
      c11_2->SaveAs("plot/dN_dcos_theta_star_weight.pdf");
      ...
      c11_3->SaveAs("plot/dN_dcos_theta_star_sample.png");
      c11_3->SaveAs("plot/dN_dcos_theta_star_sample.pdf");
      ...
      text->DrawLatexNDC(0.20, 0.26, "P_{T, #Lambda} > 0.7 GeV/c, |y_{#Lambda}| < 1.0");
      ...
      c11->SaveAs("plot/dN_dcos_theta_star.pdf");
      c11->SaveAs("plot/dN_dcos_theta_star.png");
    ...
    //--------------------------------------------------------------------- relative angle between normal vectors of event plane(EP) and production plane(PP)  ----------------------------------------------------------------    
      ...
      c12->SaveAs("plot/angle_bt_PP_EP.png");
      */
      ...
      text->DrawLatexNDC(0.6, 0.63, "P_{T, #Lambda} > 0.7 GeV/c, |y_{#Lambda}| < 1.0");

      c12_2->SaveAs("plot/sin_angle_bt_PP_EP.png");
      c12_2->SaveAs("plot/sin_angle_bt_PP_EP.pdf");
